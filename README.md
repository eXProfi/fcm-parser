...
1. Download the project:
   - With Git: `git clone https://github.com/your-username/fcm-parser.git`
   - Without Git: in PowerShell, run  
     `powershell -Command "Invoke-WebRequest -Uri 'https://github.com/your-username/fcm-parser/archive/refs/heads/main.zip' -OutFile fcm-parser.zip"; Expand-Archive fcm-parser.zip -DestinationPath .`
2. Open the project folder in Windows Explorer or PowerShell.
3. Run `install.bat`. It will download and install Python 3.11.9 into the project folder (if you do not have it yet), set up a virtual environment, and install everything the converter needs.
4. Start the converter any time with `start_converter.bat`. The app will open in your default browser.
